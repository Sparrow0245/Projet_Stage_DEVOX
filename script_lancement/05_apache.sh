...
###############################################################################
# Projet Stage DEVOX
# Déploiement Frontend Apache & Proxy API - Sentinelle V4 (Port 8080)
###############################################################################

set -euo pipefail

echo "==============================================================="
echo " Déploiement Frontend Apache sur Port 8080"
echo "==============================================================="
...
echo "[1/4] Activation des modules Apache et configuration du port 8080"
a2enmod rewrite proxy proxy_http 2>/dev/null || true

# Configuration d'Apache pour écouter sur le port 8080 uniquement
...
a2ensite sentinelle.conf 2>/dev/null || true

echo "[2/4] Génération de l'arborescence Frontend"
mkdir -p "${SOURCE_WEB}/api" "${SOURCE_WEB}/config" "${SOURCE_WEB}/assets/css" "${SOURCE_WEB}/assets/js"
...
echo "[3/4] Copie des fichiers dans les répertoires d'exposition Web"
...
echo "[4/4] Attribution des permissions et redémarrage Apache"
...
echo "==============================================================="
echo " Déploiement Frontend Terminé - Disponible sur http://127.0.0.1:8080"
echo "==============================================================="
